...
public class SearchOnLocationMessageProcessorDebuggable
    extends SearchOnLocationMessageProcessor
    implements DebugInfoProvider
{


    public SearchOnLocationMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("lng", "Lng", (java.lang.String.class), lng, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("lat", "Lat", (java.lang.String.class), lat, muleEvent));
